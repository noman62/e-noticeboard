          ...
          <div class='col-md-12 '>
            <div id='mySidebar' class='sidebar'>
              ...
              <ul>
                ...
                <li>
                  <a href='#upload' onClick='myFunction()'>
                    Upload Notice
                  </a>
                </li>
                <li>
                  <a href='#list-of-notice' onClick='myFunction2()'>
                    List of Notices
                  </a>
                </li>
                <li>
                  <a href='#profile' onClick='myFunction3()'>
                    Profile
                  </a>
                </li>
                <li>
                  <a href='#edit-profile' onClick='myFunction4()'>
                    Edit Profile
                  </a>
                </li>
              </ul>
              ...
              <div id='edit-profile' class='pt-4'>
                ...
                <div class='edit-profile'>
                  <form>
                    ...
                    <div class='form-group row'>
                      <label for='uploadImage' class='col-sm-2 col-form-label'>
                        <b>Upload Image</b>
                      </label>
                      <div class='col-sm-6'>
                        <input
